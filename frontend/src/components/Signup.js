                        ...
                        <div className='card card-refined p-4'>
                             <div className='card-body p-0'>
                                <div className='text-center'>
                                    ...
                                    <h2 className='mb-2'><span className='text-gradient fw-extrabold pb-1' style={{ fontSize: '2.2rem', letterSpacing: '-0.02em' }}>Tech Talentify</span></h2>
                                    <p className='text-muted small fw-medium mb-5'>Create your Talent Profile</p>
                                </div>
